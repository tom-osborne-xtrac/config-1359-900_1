 ...
 Inputs.XPIN_RAMP_ASSY.Value = ((Inputs.DRIVE.Value != "")  && (Inputs.DRIVE.Value != "Unknown") &&  (Inputs.COAST.Value != "") && (Inputs.COAST.Value != "Unknown")) ? ("1359-981-050A-" + Inputs.DRIVE.Value + Inputs.COAST.Value) : (""); 
